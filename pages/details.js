...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (eventid) {
        ...
        errorMessageDisplay("El evento que seleccionaste no esta disponible");
    }

});

function eventDetailsDisplay(event) {
    ...
    const estimateInfo = event.estimate ? `<li class="list-group-item text-primary-emphasis"><strong>Assistance: </strong>${event.estimate}</li>` : '';
